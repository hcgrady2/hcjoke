...
import com.hc.libcommon.view.ViewHelper;
 ...
 * all rights reserved
 */
public class HCImageView extends AppCompatImageView {
    public HCImageView(Context context) {
        super(context);
    }

    public HCImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public HCImageView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public static void setImageUrl(HCImageView view, String imageUrl, boolean isCircle) {
        view.setImageUrl(view, imageUrl, isCircle, 0);
    }

    @BindingAdapter(value = {"image_url", "isCircle", "radius"}, requireAll = false)
    public static void setImageUrl(HCImageView view, String imageUrl, boolean isCircle, int radius) {
