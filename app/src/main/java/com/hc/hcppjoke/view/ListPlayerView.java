...
import com.hc.hcppjoke.exoplayer.IPlayTarget;
import com.hc.hcppjoke.exoplayer.PageListPlay;
...
public class ListPlayerView extends FrameLayout implements IPlayTarget, PlayerControlView.VisibilityListener, Player.EventListener {
    ...
    public void bindData(String category, int widthPx, int heightPx, String coverUrl, String videoUrl) {
        ...
        if (widthPx < heightPx) {
            HCImageView.setBlurImageUrl(blur, coverUrl, 10);
